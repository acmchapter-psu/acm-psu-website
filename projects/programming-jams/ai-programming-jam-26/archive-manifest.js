  ...
  items: [
    {
      ...
      description: "The public WebForge 2026 event website.",
    },
    {
      id: "workshops",
      parent: "root",
      ...
      updated: "29 AUG 2026",
      state: "Published",
      description: "Three published workshop lessons.",
    },
    {
      id: "handouts",
      parent: "root",
      ...
      updated: "29 AUG 2026",
      state: "Published",
      description: "Participant checklists for each workshop day.",
    },
    {
      id: "planning",
      parent: "root",
      ...
      kind: "Folder",
      updated: "29 AUG 2026",
      state: "Working archive",
      description: "Filled instructor plans, grouped by version.",
    },
    {
      id: "templates",
      parent: "root",
      ...
      updated: "29 AUG 2026",
      state: "Reusable",
      description: "Blank project templates, grouped by platform and version.",
    },
    {
      id: "branding",
      parent: "root",
      ...
      updated: "29 AUG 2026",
      state: "Published",
      description: "Event media and workshop examples.",
    },
    {
      id: "lesson-day-1",
      parent: "workshops",
      name: "Day 1 — Planning & Development",
      type: "html",
      section: "workshops",
      kind: "HTML document",
      updated: "29 AUG 2026",
    ...
    },
    {
      id: "lesson-day-2",
      parent: "workshops",
      name: "Day 2 — Full-Stack Development",
      type: "html",
      section: "workshops",
      kind: "HTML document",
      updated: "29 AUG 2026",
    ...
    },
    {
      id: "lesson-day-3",
      parent: "workshops",
      name: "Day 3 — Deployment & Optimization",
      type: "html",
      section: "workshops",
      kind: "HTML document",
      updated: "29 AUG 2026",
    ...
    },
    {
      ...
      updated: "29 AUG 2026",
      state: "Working archive",
      description: "Completed planning records grouped by snapshot.",
    },
    {
      id: "filled-v1",
      parent: "filled-versions",
      name: "v1 — 2026-08-29",
      type: "folder",
      section: "documents",
      kind: "Version folder",
      updated: "29 AUG 2026",
      state: "Snapshot",
      description: "First preserved set of completed instructor plans.",
    },
    {
      id: "plan-day-1",
      parent: "filled-v1",
      name: "Day 1 Instructor Plan",
      type: "pdf",
      section: "documents",
      kind: "PDF document",
      updated: "29 AUG 2026",
    ...
    },
    {
      ...
      type: "folder",
      section: "documents",
      kind: "Platform folder",
      updated: "29 AUG 2026",
      state: "Reusable",
      description: "Notion-derived workshop templates.",
    },
    {
      id: "notion-v1",
      parent: "notion",
      ...
      updated: "29 AUG 2026",
      state: "Snapshot",
      description: "First preserved Notion template release.",
    },
    {
    ...
    {
      id: "template-organizer",
      parent: "notion-v1",
      name: "Organizer Template",
      type: "pdf",
      section: "documents",
      kind: "PDF template",
      updated: "29 AUG 2026",
    ...
    {
      id: "template-supplemental",
      parent: "notion-v1",
      name: "Supplemental Resource Template",
      type: "pdf",
      section: "documents",
      kind: "PDF template",
      updated: "29 AUG 2026",
    ...
    },
    {
      id: "diagram-example",
      parent: "branding",
      name: "Excalidraw Diagram Example",
      type: "media",
      format: "JPG",
      section: "branding",
      kind: "JPEG image",
